...
- [`examples/`](examples/) — including [`examples/DEMO.md`](examples/DEMO.md), a live run against real models (all formats, a caught hostile ONNX, and a real HF provenance check) — [screenshot](assets/demo-terminal.png)
